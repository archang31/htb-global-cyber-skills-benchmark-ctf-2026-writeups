...
A Meridian Systems Group contractor tool deployed across Task Force Nightfall's forward relay network has come under suspicion. Marco Delaunay has flagged the same anomaly across three separate nodes — a remarks field added quietly in v3.1.6, always by the same vendor, always behaving just slightly wrong. Someone inside the supply chain left a door open. Find it before Gilded Weaver does.
