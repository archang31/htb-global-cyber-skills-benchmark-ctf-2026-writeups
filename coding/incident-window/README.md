...
Authentication logs from a compromised vendor platform are flooding Anika's pipeline. Suspicious events are clustering in short bursts — the signature of a coordinated credential-stuffing campaign trying to stay below per-minute rate limits.
